    ...
    <div class="d-flex flex-column-fluid">
        <div class="container mt-10">
            ...
            <div class="card card-custom card-stretch">
                <form class="form" method="post" action="{{url('seller/add-layananjasa')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input class="form-control form-control-lg" name="i_layanan" type="text">
                                @error('i_layanan')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <select name="i_kategori" class="form-control form-control-lg">
                                    ...
                                    <option value="{{$item->idkategori}}">{{$item->kategorijasa}}</option>
                                    @endforeach
                                </select>
                                @error('i_kategori')
                                    <span class="fv-help-block" style="color:red">{{$message}}</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <textarea name="i_deskripsilayanan" id="" class="form-control form-control-lg" cols="30" rows="10"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input type="number" name="i_harga" class="form-control form-control-lg"  placeholder="">
                                @error('i_harga')
                                    <span class="fv-help-block" style="color:red">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <span class="switch">
                                    <label>
                                        <input type="checkbox" onclick="go_aktif()" id="isaktif" name="i_isaktif" value="0"/>
                                        <span></span>
                                    </label>
                                </span>
                            </div>
