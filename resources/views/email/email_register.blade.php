...
style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; margin: 0; padding: 0; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; height: 100%; width: 100%; min-width: 100%;">
  <table id="outerWrapper" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#f5f8fa" style="font-family: Poppins,Helvetica,sans-serif; font-size: 16px; color: #425b76; line-height: 1.5; width: 100%; min-width: 100%; background-color:#f5f8fa;">
    <tbody>
      <tr>
                      ...
                      <tr>
                        <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                                  ...
                                  style="font-size: 0; height: 20px; width: 100%; min-width: 100%; line-height: 0;">
                                    <tbody>
                                      <tr>
                                        ...
                                        background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overlfow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center; color:#ddc918">
                                    Mohon Konfirmasi Email Kakak
                                    </h1>
                          ...
                          <span style="font-weight: 600"> 
                            Terimakasih kakak telah mendaftar ke membangun.id. </span>
                          <p style="margin-top: 5px;">
                            Harap luangkan waktu sebentar untuk memastikan kami memiliki alamat email Kakak yang benar.
                          </p>
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                      <tr>
                                        <td align="center" style="border-radius: 3px;" bgcolor="#ddc918" width="auto">
                                            <a href="{{$details['link']}}"
                                            target="_blank" style="border: 1px solid #ddc918; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">
                                            Klik Disini</a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                          ...
                          <table cellpadding="0" border="0" cellspacing="0" width="100%" style="color: #766a42; background-color: ; font-size: 20px; width: 100%; margin: initial; min-width: 100%; ">
                            <tbody>
                              <tr>
                                <td align="center" valign="middle" style="padding: 0; ">
                                  <p style="font-size: 14px; margin: 0">
                                    <i18n-string data-key="account.verifyUserEmailAddress.noSignupHelp" data-locale-at-render="en-us">
                                        Belum mendaftar ke membangun.id? <a href="{{$details['register']}}"
                                        style="text-decoration: none; color: #bd4c00;"> Klik disini</a>.</i18n-string>
                                  </p>
                                </td>
                              </tr>
                            </tbody>
